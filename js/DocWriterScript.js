...
function OutputCoordinator(deveroID){
	...
	if(patient != null){
		...
		if(patient_detail.Referrer != null && patient_detail.Referrer == "Kaiser South Bay") DocID("cc-name").innerHTML = "Azcarraga, Ragiel.";
	} else{
...
function ChangeBG(background){
	switch(background.innerHTML){
		...
		case "New Year 2019":
			...
			break;
		case "February 2019":
			document.body.style.background = 'url(./images/February2019.jpg)';
			SetCookie("background", 'url(./images/February2019.jpg)', 365);
			break;
		default:
